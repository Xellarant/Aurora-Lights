...
public partial class CharacterSourceManagerWindow : MetroWindow, IComponentConnector
{
  internal TreeView SourcesTree;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/Aurora Builder;component/views/charactersourcemanagerwindow.xaml", UriKind.Relative));
  }
  ...
  {
    if (connectionId == 1)
      this.SourcesTree = (TreeView) target;
    else
      this._contentLoaded = true;
  }
}
