...
public class AbilitiesCollection : ObservableObject
{
  ...
  public FirstFloor.ModernUI.Presentation.RelayCommand IncreaseAbilityCommand
  {
    get
    {
      return new FirstFloor.ModernUI.Presentation.RelayCommand(new Action<object>(this.IncreaseAbility), new Func<object, bool>(this.CanIncreaseAbility));
    }
  }

  public FirstFloor.ModernUI.Presentation.RelayCommand DecreaseAbilityCommand
  {
    get
    {
      return new FirstFloor.ModernUI.Presentation.RelayCommand(new Action<object>(this.DecreaseAbility), new Func<object, bool>(this.CanDecreaseAbility));
    }
  }

  public FirstFloor.ModernUI.Presentation.RelayCommand ResetScoresCommand
  {
    get => new FirstFloor.ModernUI.Presentation.RelayCommand((Action<object>) (o => this.ResetScores()));
  }
