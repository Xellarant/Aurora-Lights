...
// Type: Builder.Presentation.Models.CharacterSheet.Content.MainSheetContent
...
public class MainSheetContent
{
  ...
  public string ConditionVision { get; set; }

  public string ConditionExhaustion { get; set; }
  ...
  public bool InitiativeMisc { get; set; }
  ...
  public string ConditionalSavingThrows { get; set; }
}
