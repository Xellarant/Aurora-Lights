...
// Type: Builder.Presentation.ViewModels.SpellcastingElementDescriptionPanelViewModel
...
public class SpellcastingElementDescriptionPanelViewModel : 
  DescriptionPanelViewModelBase,
  ISubscriber<SpellcastingElementDescriptionDisplayRequestEvent>
{
  public SpellcastingElementDescriptionPanelViewModel() => this.SupportedTypes.Add("Spell");

  public void OnHandleEvent(
    SpellcastingElementDescriptionDisplayRequestEvent args)
  {
